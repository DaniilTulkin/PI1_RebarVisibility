    ...
    public class Main : IExternalApplication
    {
        ...
        public Result OnStartup(UIControlledApplication application)
        {
            ...
            var btnAssociatingParametersToGlobalData = new RevitPushButtonData
            {
                Label = "Видимость\nарматуры",
                Panel = ribbonPanel,
                ToolTip = "Позволяет переключать для текущего вида видимость арматуры как тело или как линия.",
                CommandNamespacePath = Command.GetPath(),
                ImageName = "icon_PI1_RebarVisibility_16x16.png",
                LargeImageName = "icon_PI1_RebarVisibility_32x32.png"
            };
